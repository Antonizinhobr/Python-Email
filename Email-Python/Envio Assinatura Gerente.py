...
def EnviarEmailGerente(caminho_arquivo):
    if caminho_arquivo:
        ...
        msg = MIMEMultipart()
        msg['Subject'] = "Relatório de Monitorias pendentes de assinatura"
        ...
        <p><h4>Segue relatório de quantidade de monitorias pendentes de assinatura por Coordenador e Supervisor. Qualquer dúvida, estou a disposição.</h4></p>
        <br>
        <p><h3><font color="red">Monitorias pendentes de assinatura por coordenador(a):</font></h3></p>
        ...
        <br>
        <br>
        <p><h3><font color="red">Monitorias pendentes de assinatura por supervisor(a):</font></h3></p>
        <table style="border-collapse: collapse; width: 60%; text-align: center;">
        <tr>
